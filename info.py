...
SHORTLINK_API = environ.get('SHORTLINK_API', 'ebc2f3d68ebac000cc5480fe3f6de1ca8ac4e987')
IS_SHORTLINK = bool(environ.get('IS_SHORTLINK', False))
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '0').split()]
MAX_B_TN = environ.get("MAX_B_TN", "10")
MAX_BTN = is_enabled((environ.get('MAX_BTN', "True")), True)
PORT = environ.get("PORT", "8080")
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/fhp_request_backup')
SPRT_CHNL = environ.get('SPRT_CHNL', 'https://t.me/fhp_request_backup')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/fhp_request_backup')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/Mayank_10_04')
IS_TUTORIAL = bool(environ.get('IS_TUTORIAL', False))
HOW_TO_VERIFY = environ.get('HOW_TO_VERIFY', 'https://t.me/Mayank_10_04')
MSG_ALRT = environ.get('MSG_ALRT', 'Wʜᴀᴛ Aʀᴇ Yᴏᴜ Lᴏᴏᴋɪɴɢ Aᴛ ?')
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001967878807'))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'fhp_request_backup')
